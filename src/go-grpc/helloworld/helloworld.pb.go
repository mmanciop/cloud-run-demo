...
var file_helloworld_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x07, 0x67, 0x63, 0x72, 0x64, 0x65, 0x6d, 0x6f, 0x22, 0x22, 0x0a, 0x0c, 0x48,
	...
	0x2e, 0x67, 0x63, 0x72, 0x64, 0x65, 0x6d, 0x6f, 0x2e, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x13, 0x2e, 0x67, 0x63, 0x72, 0x64, 0x65, 0x6d, 0x6f, 0x2e,
...
var file_helloworld_proto_goTypes = []interface{}{
	(*HelloRequest)(nil), // 0: gcrdemo.HelloRequest
	(*HelloReply)(nil),   // 1: gcrdemo.HelloReply
}
var file_helloworld_proto_depIdxs = []int32{
	0, // 0: gcrdemo.Greeter.SayHello:input_type -> gcrdemo.HelloRequest
	1, // 1: gcrdemo.Greeter.SayHello:output_type -> gcrdemo.HelloReply
...
func (c *greeterClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/gcrdemo.Greeter/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Greeter_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gcrdemo.Greeter/SayHello",
	}
